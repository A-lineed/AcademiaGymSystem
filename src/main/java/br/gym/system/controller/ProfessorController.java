...
import br.gym.system.domain.ProfessorDAO;
...
private ProfessorDAO professordao;
	...
	//
		...
		public String editarProfessor(Integer codigo, Model model) {
			if(codigo!=null) {
				Professor professor=this.professordao.getById(codigo);
		...
		this.professordao.deleteById(codigo);
